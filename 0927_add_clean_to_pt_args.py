...
parser.add_argument('--clean_speech_path', type=str, default = None)
parser.add_argument('--original_pt_path',type = str,default=None)
parser.add_argument('--new_pt_path',type = str,default = None)
...
if __name__ == '__main__':
    ...
    clean_speech_path = args.clean_speech_path+"/*.pt"  #"/data2/hsl/0324_clean_pt/*.pt"
    original_pt_path = args.original_pt_path #"/data2/hsl/0323_pt_data/add_with_zky_0316/train/Cas-YanXiHu/"  # 这里面又有train又有val，还得>弄一下
    new_pt_path = args.new_pt_path #"/data2/hsl/0324_pt_with_clean/Cas-YanXiHu/"
# 对应1kHz的语谱图
    which_freq = 2
    ...
    for each_pt in all_pt:
        ...
        temp_pt_new_path = os.path.join(new_pt_path, each_pt.split("/")[-1])
        if os.path.exists(temp_pt_new_path):
            continue
        ...
        #print("temp_pt_new_path:",temp_pt_new_path,"new_pt_path:",new_pt_path,'sub:',each_pt.split(original_pt_path)[-1])
